...
import { Search, Bell, LogOut, ShieldCheck, Activity, Crown } from "lucide-react";
  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-border/60 bg-background/90 backdrop-blur-md px-4 sm:px-6 py-3 flex items-center justify-between shadow-xs">
      ...
      <div className="hidden md:flex items-center relative w-72">
        ...
        <input
          type="text"
          placeholder="Search platform users, courses, audit logs..."
          className="w-full rounded-2xl bg-muted/40 border border-border pl-9 pr-3 py-1.5 text-xs text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-amber-500 font-medium"
        />
      </div>
